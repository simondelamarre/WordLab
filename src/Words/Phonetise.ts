...
export default (a: string) => {
    const phonetik: PhonetikObject = {
        ...
        G: ["gu"],
        Er: ['eurs', 'eur', 'œur', ">>er"],
        k: ["ck", ">>que", "qu", "sc>[CONS]", "c>[CONS]", "ch>[CONS]", "ch>ia", "ck", "x>i", "c>t", "cc>a", "[VOY]<ch", "ch>o"], // K 
        ɲ: ["gn>e", "gn>a", "gn>o"], // GN
        ʀ: ["é<r", "è<r", "ë<r", "ê<r", "rr", "aire", ">>ert", ">>erds", ">>erd", ">>ère", ">>air", "aire"], // R
        C: ["ai!>ne", "ai>me", "i<en", "h<é", "h<è", "h<ê", "er>n", "er>r", "er>a", "er>e", "er>é", "er>i", "er>o", "er>u", ">>ay", ">>ers"], // É
        S: ["ss", "ç", "sc>e"], // S
...
const isConsonne = (str: string) =>
    ["z", "r", "t", "p", "q", "d", "f", "g", "h", "j", "k", "l", "m", "w", "x", "c", "v", "b", "n"].includes(str.slice(0, 1))
const isVoyelle = (str: string) =>
    ["a", "e", "i", "o", "u", "y"].includes(str.slice(0, 1))
